...
@class JZGTableIndexView;

@protocol JZGTableIndexViewDataSource
...
@interface JZGTableIndexView : UIControl

@property (nonatomic, weak) id <JZGTableIndexViewDataSource> dataSource;
...
@property (strong, nonatomic) UIFont *useFont;
