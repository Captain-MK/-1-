...
@implementation MCUtilityButtonView
...
- (void)setUtilityButtons:(NSArray *)utilityButtons WithButtonWidth:(CGFloat)width
{
    ...
    if (utilityButtons.count)
    {
        ...
        for (UIButton *button in _utilityButtons)
        {
            ...
            MCUtilityButtonTapGestureRecognizer *utilityButtonTapGestureRecognizer = [[MCUtilityButtonTapGestureRecognizer alloc] initWithTarget:_parentCell action:_utilityButtonSelector];
