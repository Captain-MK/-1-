...
+ (NSMutableDictionary *)parameterSortWithDictionarys:(NSDictionary *)dictionary
{
    NSString *signString = @"2CB3147B-D93C-964B-47AE-EEE448C84E3C";
    if(dictionary){
        NSMutableDictionary *tempDic =[NSMutableDictionary dictionary];
        [tempDic addEntriesFromDictionary:dictionary];
        //获取字典keys
        ...
        allStr = [[NSString stringWithFormat:@"%@%@",allStr,signString] lowercaseString];
        NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithDictionary:tempDic];
        [dic setValue:[[JZGEncyptClass md5HexDigest:allStr] uppercaseString] forKey:@"sign"];
        return dic;
    }
